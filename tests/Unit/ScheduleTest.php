<?php
    ...
    final class ScheduleTest extends TestCase
    {
        ...
        private static function schedule(bool $isUnpublished, ?int $start, ?int $end, int $action = Rules::ACTION_UNPUBLISH): array
        {
        ...
        public function testActionAtEnd(): void
        {
            ...
            $this->assertSame([['result' => Rules::RESULT_TRASH, 'at' => $end]], self::schedule(false, self::NOW - self::H, $end, Rules::ACTION_TRASH));
            $this->assertSame([['result' => Rules::RESULT_DELETE, 'at' => $end]], self::schedule(false, null, $end, Rules::ACTION_DELETE));
            $this->assertSame([['result' => Rules::RESULT_MOVE, 'at' => $end]], self::schedule(false, null, $end, Rules::ACTION_MOVE));
        }
        ...
        {
            $this->assertSame([['result' => Rules::RESULT_TRASH, 'at' => null]], self::schedule(true, null, self::NOW - self::H, Rules::ACTION_TRASH));
        }
